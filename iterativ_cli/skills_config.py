"""
Skills configuration for Iterativ Agent.
`iterativ skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.iterativ/config.yaml under:
...
from iterativ_cli.config import cfg_get, load_config, save_config
from iterativ_cli.colors import Colors, color
from iterativ_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `iterativ skills`."""
    from iterativ_cli.curses_ui import curses_checklist
