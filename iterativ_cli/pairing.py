...
Usage:
    iterativ pairing list              # Show all pending + approved users
    iterativ pairing approve <platform> <code>  # Approve a pairing code
    iterativ pairing revoke <platform> <user_id> # Revoke user access
    iterativ pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle iterativ pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: iterativ pairing {list|approve|revoke|clear-pending}")
        print("Run 'iterativ pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.iterativ/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'iterativ pairing list' to see pending codes.\n")
