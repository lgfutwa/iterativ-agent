...
Used by ``iterativ profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``iterativ_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Iterativ Agent kanban board.
...
Rules:
  ...
  - Never write "Iterativ Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_iterativ_home())
        else:
