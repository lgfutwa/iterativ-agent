...
Invoked by ``iterativ kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Iterativ Agent board.
...
def _profile_author() -> str:
    """Mirror of ``iterativ_cli.kanban._profile_author``."""
    return (
