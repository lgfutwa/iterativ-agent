...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_iterativ_agent_browser()
    ),
...
def _has_iterativ_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ITERATIV_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-IterativHome", str(get_iterativ_home()),
        ]
    else:
