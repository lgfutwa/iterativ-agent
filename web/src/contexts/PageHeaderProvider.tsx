...
export function PageHeaderProvider({
  ...
  const isComputerRoute = pathname === "/computer" || pathname === "/computer/";
  ...
  return (
    <PageHeaderContext.Provider value={value}>
      <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col overflow-hidden">
        {!isComputerRoute && !isChatRoute && (
          <header
            className={cn(
              "z-1 w-full shrink-0",
              "box-border border-b border-stone-200",
              "bg-[#f6f3ec]/80 backdrop-blur-sm",
              // Mobile stacks title + toolbar; desktop stays one row.
          ...
          >
            ...
            >
              ...
              >
                <h1
                  className={cn(
                    "min-w-0 text-sm font-semibold tracking-normal text-stone-950",
                    afterTitle && isEnvRoute
