...
const STORAGE_KEY = "iterativ-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `iterativ_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "iterativ-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-iterativ-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-iterativ-theme-font", "true");
