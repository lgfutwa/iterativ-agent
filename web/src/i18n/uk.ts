...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateIterativ: "Оновити Iterativ",
    updatingIterativ: "Оновлення Iterativ…",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни Iterativ (паритет з `iterativ plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.iterativ/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.iterativ/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.iterativ/skills/",
