...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateIterativ: "Iterativ'i Güncelle",
    updatingIterativ: "Iterativ güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Hermes eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`iterativ plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.iterativ/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.iterativ/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.iterativ/skills/ adresinden yüklenir",
