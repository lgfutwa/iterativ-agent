...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateIterativ: "Update Iterativ",
    updatingIterativ: "Updating Iterativ…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Iterativ plugins (`iterativ plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.iterativ/plugins/?",
    removeHint: "Only user-installed plugins under ~/.iterativ/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.iterativ/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Iterativ Achievements",
      subtitle:
        "Collectible Iterativ badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Iterativ session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Iterativ more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Iterativ sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Iterativ is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Iterativ Agent ☤",
    },
  },
