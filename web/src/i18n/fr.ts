...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateIterativ: "Mettre à jour Iterativ",
    updatingIterativ: "Mise à jour de Iterativ…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Hermes (parité avec `iterativ plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.iterativ/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.iterativ/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.iterativ/skills/",
