...
export const zhHant: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "探索、安裝、啟用並更新 Iterativ 外掛（對齊 `iterativ plugins` CLI）。",
    ...
    removeConfirm: "從 ~/.iterativ/plugins/ 移除此外掛？",
    removeHint: "僅可移除位於 ~/.iterativ/plugins 下使用者安裝的外掛。",
  ...
  skills: {
    ...
    categories: "分類",
    filters: "篩選",
    noSkills: "找不到技能。技能由 ~/.iterativ/skills/ 載入",
