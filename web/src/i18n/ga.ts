...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateIterativ: "Nuashonraigh Iterativ",
    updatingIterativ: "Ag nuashonrú Iterativ…",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Hermes (paireacht le `iterativ plugins`).",
    ...
    removeConfirm: "Bain an plugin seo ó ~/.iterativ/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.iterativ/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.iterativ/skills/",
