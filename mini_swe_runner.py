#!/usr/bin/env python3
"""
SWE Runner with Iterativ Trajectory Format

A runner that uses Iterativ-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Iterativ-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Iterativ-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Iterativ format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Iterativ-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Iterativ-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Iterativ Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Iterativ-Agent's built-in execution environments
    and outputs trajectories in Iterativ-Agent format.
    """
    ...
    def _convert_to_iterativ_format(
        self,
        ...
        """
        Convert internal message format to Iterativ trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Iterativ trajectory format
        trajectory = self._convert_to_iterativ_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Iterativ trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Iterativ Trajectory Format")
    print("=" * 60)
