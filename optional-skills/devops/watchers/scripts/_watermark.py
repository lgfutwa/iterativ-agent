...
def _state_dir() -> Path:
    ...
    # Default: $HERMES_HOME/watcher-state/, falling back to ~/.iterativ/watcher-state/.
    iterativ_home = os.environ.get("HERMES_HOME") or str(Path.home() / ".iterativ")
    return Path(iterativ_home) / "watcher-state"
