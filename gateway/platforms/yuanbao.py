...
try:
    ...
    _ITERATIV_VERSION = "0.0.0"

_APP_VERSION = _ITERATIV_VERSION
_BOT_VERSION = _ITERATIV_VERSION
_YUANBAO_INSTANCE_ID = str(ITERATIV_INSTANCE_ID)  # single source: yuanbao_proto.ITERATIV_INSTANCE_ID
