...
Config: ~/.iterativ/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.iterativ/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_iterativ_home()`` helper (ITERATIV_HOME-aware and
...
RULES_FILE = get_iterativ_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_iterativ_home() / "feishu_comment_pairing.json"
