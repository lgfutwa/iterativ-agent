...
Trust levels:
  - builtin:   Ships with Iterativ. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.iterativ/\.env|\~/\.iterativ/\.env',
     "iterativ_env_access", "critical", "exfiltration",
     "directly references Iterativ secrets file"),
    ...
    (r'\.iterativ/config\.yaml|\.iterativ/SOUL\.md',
     "iterativ_config_mod", "critical", "persistence",
     "references Iterativ configuration files directly"),
