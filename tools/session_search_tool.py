...
the get_anchored_view / get_messages_around primitives in iterativ_state.
...
# Third-party integrations tag their sessions with ITERATIV_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from iterativ_state import DEFAULT_DB_PATH
