...
def auth_json_path():
    """Return the Iterativ auth store path, respecting ITERATIV_HOME overrides."""
    return get_iterativ_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from iterativ_cli.auth import resolve_nous_access_token
