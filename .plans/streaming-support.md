# Streaming LLM Response Support for Iterativ Agent
...
```
ITERATIV_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ITERATIV_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `iterativ_cli/config.py` | 1 | +streaming config defaults |
...
ITERATIV_STREAMING_ENABLED=true
```
