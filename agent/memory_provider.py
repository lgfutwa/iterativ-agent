...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - iterativ_home (str): The active ITERATIV_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.iterativ``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "iterativ").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'iterativ memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], iterativ_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'iterativ memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``iterativ_home`` is the active ITERATIV_HOME directory path.
