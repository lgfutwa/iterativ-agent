...
(3 SDK retries x 3 Iterativ retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_iterativ_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".iterativ")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Iterativ, ...) behind one endpoint.  A 429 can mean either:
