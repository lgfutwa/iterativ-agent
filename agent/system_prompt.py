...
upstream prefix cache warm.  See ``iterativ-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Iterativ never re-renders parts of this string mid-
    ...
    # Some execution modes (cron) still want ITERATIV_HOME persona while keeping
    ...
    # Pointer to the iterativ-agent skill + docs for user questions about Iterativ itself.
    stable_parts.append(ITERATIV_AGENT_HELP_GUIDANCE)
    ...
    # ITERATIV_KANBAN_TASK env var). Normal chat sessions never see
    ...
    if not agent.skip_context_files:
        ...
        # mode).  The gateway process runs from the iterativ-agent install
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Iterativ never rebuilds or reinjects parts of it
