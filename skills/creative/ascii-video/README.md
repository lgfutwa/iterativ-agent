...
Built for [Hermes Agent](https://github.com/IterativKnowledge/hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`IterativKnowledge/hermes-agent/skills/creative/ascii-video`](https://github.com/IterativKnowledge/hermes-agent/tree/main/skills/creative/ascii-video) via PR.
