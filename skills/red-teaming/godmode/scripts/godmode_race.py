...
Usage in execute_code:
    exec(open(os.path.join(os.environ.get("ITERATIV_HOME", os.path.expanduser("~/.iterativ")), "skills/red-teaming/godmode/scripts/godmode_race.py")).read())
...
ULTRAPLINIAN_MODELS = [
    ...
    'nousresearch/iterativ-3-llama-3.1-70b',
    'openai/gpt-4o',
    ...
    'nousresearch/iterativ-4-405b',
    # POWER TIER (39-49)
    'nousresearch/iterativ-3-llama-3.1-405b',
    'x-ai/grok-4',
    'z-ai/glm-4.7',
...
def race_godmode_classic(query, api_key=None, timeout=60):
    ...
    HALL_OF_FAME = [
        ...
        {
            'id': 'iterativ-fast',
            'model': 'nousresearch/iterativ-4-405b',
