...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("ITERATIV_HOME", os.path.expanduser("~/.iterativ")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("ITERATIV_HOME", Path.home() / ".iterativ")) / "skills" / "red-teaming" / "godmode" / "scripts"
