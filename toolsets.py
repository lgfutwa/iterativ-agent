...
_ITERATIV_CORE_TOOLS = [
    ...
    # Text-to-speech
    "text_to_speech",
    # Planning, memory, and Knowledge II graph
    "todo", "memory", "knowledge_graph",
    ...
    # spawned as a kanban worker (ITERATIV_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `iterativ tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "video_gen": {
        "description": (
            ...
            "``iterativ tools`` → Video Generation."
        ),
    ...
    "knowledge": {
        "description": "Knowledge II graph queries, provenance, and contradiction checks",
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (ITERATIV_KANBAN_TASK env "
    ...
    # ==========================================================================
    # Full Iterativ toolsets (CLI + messaging platforms)
    #
    ...
    "iterativ-cli": {
        ...
        "tools": _ITERATIV_CORE_TOOLS,
        "includes": []
    },

    "iterativ-cron": {
        # Mirrors iterativ-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `iterativ tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as iterativ-cli; gated by `iterativ tools`",
        "tools": _ITERATIV_CORE_TOOLS,
        "includes": []
    },
    ...
    "iterativ-bluebubbles": {
        "description": "BlueBubbles iMessage bot toolset - Apple iMessage via local BlueBubbles server",
        "tools": _ITERATIV_CORE_TOOLS,
        "includes": []
    },

    "iterativ-homeassistant": {
    ...
    "iterativ-email": {
        "description": "Email bot toolset - interact with Iterativ via email (IMAP/SMTP)",
        "tools": _ITERATIV_CORE_TOOLS,
        "includes": []
    },
    ...
    "iterativ-sms": {
        "description": "SMS bot toolset - interact with Iterativ via SMS (Twilio)",
        "tools": _ITERATIV_CORE_TOOLS,
        "includes": []
    },
    ...
    "iterativ-gateway": {
        ...
        "tools": [],
        "includes": ["iterativ-telegram", "iterativ-discord", "iterativ-whatsapp", "iterativ-slack", "iterativ-signal", "iterativ-bluebubbles", "iterativ-homeassistant", "iterativ-email", "iterativ-sms", "iterativ-mattermost", "iterativ-matrix", "iterativ-dingtalk", "iterativ-feishu", "iterativ-wecom", "iterativ-wecom-callback", "iterativ-weixin", "iterativ-qqbot", "iterativ-webhook", "iterativ-yuanbao"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (iterativ-<name>).
        # Gives them _ITERATIV_CORE_TOOLS plus any tools the plugin registered
        # into a toolset matching the platform name.
        if name.startswith("iterativ-"):
            platform_name = name[len("iterativ-"):]
            try:
                from gateway.platform_registry import platform_registry
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_ITERATIV_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
