 ...
 *
 * Symptom: in `iterativ --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@iterativ/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using iterativ --tui and as i type multiline my caret at the end will often ' +
