"""
Cron job scheduling system for Iterativ Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    iterativ gateway install    # Install as a user service
    sudo iterativ gateway install --system  # Linux servers: boot-time system service
    iterativ gateway            # Or run in foreground
