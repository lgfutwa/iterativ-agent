...
def _profile_user_agent() -> str:
    """Return a ``iterativ-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from iterativ_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"iterativ-cli/{_ver}"
    except Exception:
        return "iterativ-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # iterativ-cli UA so the catalog endpoint is reachable.
