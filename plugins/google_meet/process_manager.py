...
session-scoped state file under ``$ITERATIV_HOME/workspace/meetings/.active.json``
...
# File + directory layout (under $ITERATIV_HOME):
#
#   workspace/meetings/
...
def _root() -> Path:
    return Path(get_iterativ_home()) / "workspace" / "meetings"
...
def start(
    ...
    *,
    ...
    If a bot is already running for this iterativ install, leave it first —
