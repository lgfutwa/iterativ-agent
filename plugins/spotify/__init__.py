...
``_check_spotify_available()`` — when the user has not run ``iterativ auth
spotify``, the tools remain registered (so they appear in ``iterativ
...
The Spotify auth flow (``iterativ auth spotify``), CLI plumbing, and docs
