...
Mounted at /api/plugins/iterativ-achievements/ by Iterativ dashboard.
"""
...
def state_path() -> Path:
    return get_iterativ_home() / "plugins" / "iterativ-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_iterativ_home() / "plugins" / "iterativ-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_iterativ_home() / "plugins" / "iterativ-achievements" / "scan_checkpoint.json"
...
def _start_background_scan() -> None:
    ...
    with _BACKGROUND_SCAN_LOCK:
        ...
        thread = threading.Thread(
            ...
            name="iterativ-achievements-scan",
            daemon=True,
        )
