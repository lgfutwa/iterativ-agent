...
nix run github:IterativKnowledge/hermes-agent -- setup
nix run github:IterativKnowledge/hermes-agent -- chat

# Or install persistently
nix profile install github:IterativKnowledge/hermes-agent
hermes setup
hermes chat
```
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:IterativKnowledge/hermes-agent";
  };
...
```nix
{
  inputs.hermes-agent.url = "github:IterativKnowledge/hermes-agent";
