...
Tracks [issue #7816](https://github.com/IterativKnowledge/hermes-agent/issues/7816).
...
- [Issue #7816](https://github.com/IterativKnowledge/hermes-agent/issues/7816) — original proposal and design discussion
