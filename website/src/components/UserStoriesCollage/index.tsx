  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Iterativ Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Iterativ &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Iterativ?{' '}
        <a
          href="https://github.com/IterativKnowledge/iterativ-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/IterativKnowledge" target="_blank" rel="noopener noreferrer">
          Iterativ Knowledge Discord
        </a>{' '}
