#!/usr/bin/env python3
"""Build the Iterativ Skills Index — a centralized JSON catalog of all skills.
...
`iterativ skills search/install` can use it without hitting the GitHub API.
...
# Ensure ITERATIV_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Iterativ Skills Index...", flush=True)
