...
DEFAULT_DATASETS = [
    "IterativKnowledge/swe-terminus-agent-glm-kimi-minimax",
    "IterativKnowledge/iterativ-agent-megascience-sft1",
    "IterativKnowledge/Iterativ-Agent-Thinking-GLM-4.7-SFT2",
    "IterativKnowledge/Iterativ-Agent-Thinking-GLM-4.7-SFT1",
    "IterativKnowledge/terminal-tasks-glm-iterativ-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "IterativKnowledge/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload IterativKnowledge/{output_name} {final_output}")
