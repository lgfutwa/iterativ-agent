...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Iterativ\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "iterativ@nousresearch.com",
    "iterativ-audit@example.com",
    "iterativ@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "IterativKnowledge/iterativ-agent",
                "--state", "merged",
