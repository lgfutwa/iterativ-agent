#!/usr/bin/env python3
"""Build the Iterativ Model Catalog — a centralized JSON manifest of curated models.
...
Iterativ CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Iterativ release.
...
``https://iterativ-agent.nousresearch.com/docs/api/model-catalog.json``
"""
...
# Ensure ITERATIV_HOME is set for imports that touch it at module level.
os.environ.setdefault("ITERATIV_HOME", os.path.join(os.path.expanduser("~"), ".iterativ"))

from iterativ_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "iterativ-agent repo",
            "docs": "https://iterativ-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
