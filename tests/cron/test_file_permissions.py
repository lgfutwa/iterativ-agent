...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("iterativ_cli.config.get_config_path", return_value=config_path), \
             patch("iterativ_cli.config.ensure_iterativ_home"):
    ...
    def test_ensure_iterativ_home_sets_0700(self):
        home = Path(self.tmpdir) / ".iterativ"
        with patch("iterativ_cli.config.get_iterativ_home", return_value=home):
