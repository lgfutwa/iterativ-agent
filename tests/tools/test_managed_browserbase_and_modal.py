...
def _enable_managed_nous_tools(monkeypatch):
    ...
    iterativ_cli.auth and iterativ_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("iterativ_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("iterativ_cli.models.check_nous_free_tier", lambda: False)
