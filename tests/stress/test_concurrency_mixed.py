...
def worker_loop(worker_id: int, iterativ_home: str, result_file: str) -> None:
...
def reclaimer_loop(iterativ_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="iterativ_mixed_stress_")
    print(f"ITERATIV_HOME = {home}")
