"""Tests for iterativ_cli/bundles.py — the `iterativ bundles` CLI subcommand."""
...
from iterativ_cli.bundles import (
    bundles_command,
    register_cli,
)
...
def bundles_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("ITERATIV_BUNDLES_DIR", str(bundles_dir))
