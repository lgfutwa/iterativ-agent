...
The main() function in iterativ_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `iterativ -c model`
...
def _build_parser():
    """Build a minimal replica of the iterativ top-level parser."""
