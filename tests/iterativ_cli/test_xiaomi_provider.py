...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from iterativ_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ITERATIV_OVERLAYS
        overlay = ITERATIV_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify iterativ doctor recognizes Xiaomi env vars."""
