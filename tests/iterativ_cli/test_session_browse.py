"""Tests for the interactive session browser (`iterativ sessions browse`).
...
from iterativ_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """iterativ sessions browse should be parseable."""
        from iterativ_cli.main import main as _main_entry
