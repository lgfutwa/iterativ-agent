...
def test_import_loads_env_from_iterativ_home(tmp_path, monkeypatch):
    home = tmp_path / ".iterativ"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-iterativ-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-iterativ-home"
