"""Tests for CodexEventProjector — codex item/* events → Iterativ messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Iterativ' message alternation invariant."""
